...
namespace Allard.Configinator.Core.Model.Validators
{
    ...
    public class HierarchyValidator
    {
        ...
        private void Validate()
        {
            ...
            foreach (var b in toTest.Bases) Validate(b, encountered);
        }
        ...
        private void Validate(string baseName, ISet<string> encountered)
        {
            if (encountered.Contains(baseName))
                throw new InvalidOperationException("Hierarchy issue. ElementToTest=" + toTest.Name +
                                                    ", Repeating segment: " + baseName);
            ...
            foreach (var b in nextElement.Bases) Validate(b, encountered);
        }
